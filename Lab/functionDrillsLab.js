...
//CODE HERE
const bestMovie = (one) => {console.log(`${one} is the best movie ever!`)}
bestMovie('Shrek')
...
emailCheck('        jskskater@gmail.com               ')
...
console.log(acsending(sampleArray))
